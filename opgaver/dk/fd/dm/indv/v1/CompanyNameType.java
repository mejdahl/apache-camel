...
/**
 * 
 *                 This type defines a company name.
 * 
 *                 The from- and toDate defines the validity interval. If the toDate is not present then the company name
 *                 is valid to infinity.
 *                 Name contains the name of the company.
 *                 Description is a text describing the origins of the company name
 *             
 * 
