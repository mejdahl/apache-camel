 ...
 * generated in the dk.naturerhverv.fishery.sm.cmon.common.findvessels.v2 package. 
...
public class ObjectFactory {
    ...
    private final static QName _FindVesselsRequest_QNAME = new QName("urn:dk:naturerhverv:fishery:sm:cmon:Common:FindVessels:v2.0", "FindVesselsRequest");
    private final static QName _FindVesselsResponse_QNAME = new QName("urn:dk:naturerhverv:fishery:sm:cmon:Common:FindVessels:v2.0", "FindVesselsResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: dk.naturerhverv.fishery.sm.cmon.common.findvessels.v2
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "urn:dk:naturerhverv:fishery:sm:cmon:Common:FindVessels:v2.0", name = "FindVesselsRequest")
     ...
     * 
     */
    @XmlElementDecl(namespace = "urn:dk:naturerhverv:fishery:sm:cmon:Common:FindVessels:v2.0", name = "FindVesselsResponse")
