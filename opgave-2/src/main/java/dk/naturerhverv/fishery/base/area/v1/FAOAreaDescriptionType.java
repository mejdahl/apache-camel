 ...
 *       &lt;sequence>
 *         &lt;element name="Area" type="{urn:dk:naturerhverv:fishery:base:area:v1}FAOAreaType" minOccurs="0"/>
 *         &lt;element name="SubArea" type="{urn:dk:naturerhverv:fishery:base:area:v1}FAOSubAreaType" minOccurs="0"/>
 *         &lt;element name="Division" type="{urn:dk:naturerhverv:fishery:base:area:v1}FAODivisionType" minOccurs="0"/>
 *         &lt;element name="SubDivision" type="{urn:dk:naturerhverv:fishery:base:area:v1}FAOSubDivisionType" minOccurs="0"/>
 *         &lt;element name="Unit" type="{urn:dk:naturerhverv:fishery:base:area:v1}FAOUnitType" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
